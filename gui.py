...
class ChatWindow(Window):
    ...
    def build_window(self):
        ...
        self.messages_list = scrolledtext.ScrolledText(frame00, wrap='word', font=self.font,bg="lightgreen")
        self.messages_list.insert(tk.END, 'ยินดีต้อนรับสู่ระบบสแชทสั่งอาหารออนไลน์\n')
        ...
        self.send_button = tk.Button(frame03, text='Send', font=self.font,bg="pink",bd=10)
        self.send_button.bind('<Button-1>', self.send_entry_event)

        # Button for exiting
        self.exit_button = tk.Button(frame03, text='Exit', font=self.font,bg="red",bd=10)
